 ...
 <script>
    function togglePasswordVisibility(passwordInputId, eyeIconId) {
        ...
        if (passwordInput.type === "password") {
            ...
            eyeIcon.src = "{{ asset('assets/images/eye-on.svg') }}"; // Change to the icon that indicates hiding the password
        } else {
            passwordInput.type = "password";
            eyeIcon.src = "{{ asset('assets/images/eye-off.svg') }}"; // Change to the icon that indicates showing the password
        }
    }
</script>
